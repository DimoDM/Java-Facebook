...
import facebook.service.implementation.ProfileServiceImpl;
...
public class FriendRequestController extends BaseController {
    ...
    @Autowired
    public FriendRequestController(FriendRequestService friendRequestService, FriendRequestRepository friendRequestRepository, ProfileServiceImpl profileService, UserService userService) {
